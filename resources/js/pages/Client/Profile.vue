<template>
    <div>
        <modal :isOpen.sync="modalOpen">
            <div class="border rounded-lg p-4 mb-10 text-xs">
                <h6 class="tracking-wider uppercase text-xs text-yellow-600">
                    Info
                </h6>
                <p>
        ...
        <section class="flex flex-wrap md:flex-no-wrap justify-between">
            ...
            <div class="w-full md:flex-grow" style="--delay: 0.3s">
                ...
                <card-bg extend="mb-10">
                    <div class="mb-6">
                        <h3 class="text-lg font-bold">Voting link</h3>
                        <p class="text-sm">
...
export default {
    ...
    components: {
        ...
        IdentityForm: () =>
            import(
                /* webpackChunkName: "profile_comps" */ "../Profile/Identity"
            ),
        MedicalsForm: () =>
            import(
                /* webpackChunkName: "profile_comps" */ "../Profile/Medicals"
            ),
        EmergencyForm: () =>
            import(
                /* webpackChunkName: "profile_comps" */ "../Profile/Emergency"
            ),
        SocialForm: () =>
            import(/* webpackChunkName: "profile_comps" */ "../Profile/Social"),
        TravelForm: () =>
            import(/* webpackChunkName: "profile_comps" */ "../Profile/Travel"),
        PersonaForm: () =>
            import(
                /* webpackChunkName: "profile_comps" */ "../Profile/Persona"
            ),
        StepDetail: () =>
            import(
        ...
        Modal: () =>
            import(
                /* webpackChunkName: "settings_page" */ "../../components/Modal"
            ),
    },
};
</script>
