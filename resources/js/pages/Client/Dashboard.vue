        ...
        <section class="flex flex-wrap md:flex-no-wrap">
            <div class="md:w-4/12 w-full mb-10 md:mr-10">
                <card-bg>
                    ...
                    <div class="mb-5">
                        <h6 class="uppercase text-xs tracking-widest">
                            Competition
                        </h6>
                    ...
                    <div>
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <p class="text-gray-900 capitalize">
                                {{ $page.user.profile_stage }}
                            </p>
                        </div>
                        <div
                            class="h-3 rounded-lg overflow-hidden bg-primaryBg-300"
                        >
                            <div
                                :class="[`h-8 bg-${profileStage.color}-500`]"
                                :style="{ width: `${profileStage.width}%` }"
                            ></div>
                        </div>
                    </div>
                </card-bg>
            ...
            <div class="md:w-9/12 w-full">
                <card-bg extend="mb-10">
                    ...
                    <div
                        v-if="$page.user.has_paid === 1"
                        class="flex justify-end mt-6"
                    >
                        <inertia-link
                            :href="$route.relativePath('client.profile.index')"
                            class="inline-flex p-1 items-center text-yellow-500 hover:text-yellow-600"
                        >
                            <span class="mr-2">View and Edit Profile</span>
                ...
                <card-bg extend="mb-10" v-if="$page.user.has_paid === 0">
                    <form
                        :action="$route.url('client.payment.initiate')"
                        method="POST"
                        id="payment"
                    ></form>
                    <input
                    ...
                    />
                    <div
                        class="rounded-md bg-auto bg-yellow-500 p-5 mb-5"
                        :style="{
                            'background-image': `url(${$page.auth.settings.app_url}/img/background_1.svg)`,
                        }"
                    >
                        <div class="w-9/12">
                            <h3
                                class="text-2xl md:text-3xl mb-1 text-black font-bold"
                            >
                                Please Make Payment
                            </h3>
                    ...
                    <div class="flex mb-5 justify-between items-center">
                        ...
                        <span class="text-2xl text-black font-bold md:text-4xl"
                            >{{ getCurrencySymbol
                                ...
                                getRegisterationFee | changeNumberFormat
                            }}</span
                        >
                    </div>
                    <div>
                ...
                <card-bg v-if="$page.user.has_paid === 1" extend="mb-10">
                    ...
                    <div class="flex flex-wrap mb-5">
                        ...
                        <div class="w-full md:w-4/12 mb-4 md:pr-2">
                            ...
                            <p class="text-gray-900">
                                ₦{{
                                    transactionData.amount | changeNumberFormat
                                }}
                            </p>
                        </div>
                        <div class="w-full md:w-4/12 mb-4 md:pr-2">
                        ...
                        <div class="w-full md:w-4/12 mb-4 md:pr-2">
                            ...
                            <p class="text-gray-900">
                                {{ transactionData.human_date_of_payment }}
                            </p>
                        </div>
                    </div>
...
export default {
    ...
    components: {
        ProfileCard: () =>
            import(
                /* webpackChunkName: "settings_page" */ "../../components/ProfileCard2"
            ),
        StepDetail: () =>
            import(
                /* webpackChunkName: "settings_page" */ "../../components/StepDetails"
            ),
    },
    data() {
        return {
    ...
    computed: {
        ...
        getRegisterationFee() {
            return this.selectedCountry === "Nigeria"
                ? parseFloat(this.$page.auth.settings.naira_charge)
                : parseFloat(this.$page.auth.settings.dollar_charge);
        },
        transactionData() {
            return (
                this.$page.user.transactions.length > 0 &&
                this.$page.user.transactions[0]
            );
        },
        competitionData() {
