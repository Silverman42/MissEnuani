    ...
    <div>
        ...
        <div class="mb-10">
            <select-input
                ...
                :value="educational_cert"
                @input="changeCertificates($event)"
                :error="$page.errors.educational_cert || ''"
                form="persona"
            >
...
export default {
    ...
    methods: {
        ...
        submitForm() {
            ...
            this.$inertia.post(
                this.$route.relativePath("client.profile.update.persona"),
                { educational_cert, hobbies, ambition, profession }
            );
        },
        mounted() {
            this.assignDefaults();
