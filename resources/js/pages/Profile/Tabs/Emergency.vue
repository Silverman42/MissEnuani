    ...
    <div>
        ...
        <div class="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
            <div class="break-words">
                ...
                <p class="capitalize">{{ user.emergency_name || "None" }}</p>
            </div>
            <div class="break-words">
                <h3 class="uppercase text-xs tracking-widest">
                ...
                <p class="capitalize">
                    {{ user.emergency_phone_number || "None" }}
                </p>
            </div>
            <div class="break-words">
                <h3 class="uppercase text-xs tracking-widest">
                ...
                <p class="capitalize">
                    {{ user.emergency_relationship || "None" }}
                </p>
            </div>
            <div class="break-words">
                <h3 class="uppercase text-xs tracking-widest">
                ...
                <a
                    :href="`mailto:${user.emergency_email || '#'}`"
                    class="underscore"
                    >{{ user.emergency_email || "None" }}</a
                >
            </div>
        </div>
    </div>
