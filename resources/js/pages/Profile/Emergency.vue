    ...
    <div>
        ...
        <div class="mb-3">
            <text-input
                ...
                :error="$page.errors.emergency_name || ''"
                form="emergency"
                >Required</text-input
            >
        </div>
        <div class="mb-3">
            <text-input
                ...
                :error="$page.errors.emergency_phone_number || ''"
                form="emergency"
                >Required</text-input
            >
        </div>
        <div class="mb-3">
            <text-input
                ...
                v-model="emergency_relationship"
                :error="$page.errors.emergency_relationship || ''"
                form="emergency"
                >Required</text-input
            >
        </div>
        <div class="mb-10">
            <text-input
                ...
                :error="$page.errors.emergency_email || ''"
                form="emergency"
                >Required</text-input
            >
        </div>
...
export default {
    ...
    methods: {
        ...
        submitForm() {
            ...
            this.$inertia.post(
                this.$route.relativePath("client.profile.update.emergency"),
                {
                    emergency_name,
                    emergency_relationship,
                    emergency_email,
