    ...
    <div>
        <alert-container>
            <alert
                ...
                @closeAlert="removeAlertSynchronously(index)"
                :key="index"
            ...
            <div class="xl:w-9/12 w-11/12 mx-auto">
                <div class="flex justify-between items-center py-4">
                    <div class="w-20 flex items-center">
                        ...
                        />
                        <p class="text-white ml-3 capitalize">
                            {{ $page.auth.settings.app_name }}
                        </p>
                    </div>
                ...
                <nav class="w-full">
                    <ul
                        class="list-none m-0 p-0 flex overflow-x-auto items-center py-4"
                    >
                        <li
                            class="inline-block reveal-up"
                            :style="{ '--delay': '0.1s' }"
                        >
                            <inertia-link
                                class="nav-link"
...
export default {
    ...
    components: {
        Alert: () =>
            import(
                /* webpackChunkName: "layout_comps" */ "../components/Alert"
            ),
        AlertContainer: () =>
            import(
        ...
        pushNewAlert() {
            ...
            if (this.$page.auth.alert_type !== null) {
                alertList.push({
                    ...
                    color:
                        vm.$page.auth.alert_type === "success"
                            ? "green"
                            : "red",
